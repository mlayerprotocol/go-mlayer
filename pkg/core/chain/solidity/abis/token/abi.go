...
func (_Abi *AbiTransactor) Approve(opts *bind.TransactOpts, guy common.Address, wad *big.Int) (*types.Transaction, error) {
	return _Abi.contract.Transact(opts, "approve", guy, wad)
}

// Approve is a paid mutator transaction binding the contract method 0x095ea7b3.
//
// Solidity: function approve(address guy, uint256 wad) returns(bool)
func (_Abi *AbiSession) Approve(guy common.Address, wad *big.Int) (*types.Transaction, error) {
	return _Abi.Contract.Approve(&_Abi.TransactOpts, guy, wad)
}

// Approve is a paid mutator transaction binding the contract method 0x095ea7b3.
//
// Solidity: function approve(address guy, uint256 wad) returns(bool)
func (_Abi *AbiTransactorSession) Approve(guy common.Address, wad *big.Int) (*types.Transaction, error) {
	return _Abi.Contract.Approve(&_Abi.TransactOpts, guy, wad)
}
...
func (_Abi *AbiTransactor) Transfer(opts *bind.TransactOpts, dst common.Address, wad *big.Int) (*types.Transaction, error) {
	return _Abi.contract.Transact(opts, "transfer", dst, wad)
}

// Transfer is a paid mutator transaction binding the contract method 0xa9059cbb.
//
// Solidity: function transfer(address dst, uint256 wad) returns(bool)
func (_Abi *AbiSession) Transfer(dst common.Address, wad *big.Int) (*types.Transaction, error) {
	return _Abi.Contract.Transfer(&_Abi.TransactOpts, dst, wad)
}

// Transfer is a paid mutator transaction binding the contract method 0xa9059cbb.
//
// Solidity: function transfer(address dst, uint256 wad) returns(bool)
func (_Abi *AbiTransactorSession) Transfer(dst common.Address, wad *big.Int) (*types.Transaction, error) {
	return _Abi.Contract.Transfer(&_Abi.TransactOpts, dst, wad)
}
...
func (_Abi *AbiTransactor) TransferFrom(opts *bind.TransactOpts, src common.Address, dst common.Address, wad *big.Int) (*types.Transaction, error) {
	return _Abi.contract.Transact(opts, "transferFrom", src, dst, wad)
}

// TransferFrom is a paid mutator transaction binding the contract method 0x23b872dd.
//
// Solidity: function transferFrom(address src, address dst, uint256 wad) returns(bool)
func (_Abi *AbiSession) TransferFrom(src common.Address, dst common.Address, wad *big.Int) (*types.Transaction, error) {
	return _Abi.Contract.TransferFrom(&_Abi.TransactOpts, src, dst, wad)
}

// TransferFrom is a paid mutator transaction binding the contract method 0x23b872dd.
//
// Solidity: function transferFrom(address src, address dst, uint256 wad) returns(bool)
func (_Abi *AbiTransactorSession) TransferFrom(src common.Address, dst common.Address, wad *big.Int) (*types.Transaction, error) {
	return _Abi.Contract.TransferFrom(&_Abi.TransactOpts, src, dst, wad)
}
...
func (_Abi *AbiTransactor) Withdraw(opts *bind.TransactOpts, wad *big.Int) (*types.Transaction, error) {
	return _Abi.contract.Transact(opts, "withdraw", wad)
}

// Withdraw is a paid mutator transaction binding the contract method 0x2e1a7d4d.
//
// Solidity: function withdraw(uint256 wad) returns()
func (_Abi *AbiSession) Withdraw(wad *big.Int) (*types.Transaction, error) {
	return _Abi.Contract.Withdraw(&_Abi.TransactOpts, wad)
}

// Withdraw is a paid mutator transaction binding the contract method 0x2e1a7d4d.
//
// Solidity: function withdraw(uint256 wad) returns()
func (_Abi *AbiTransactorSession) Withdraw(wad *big.Int) (*types.Transaction, error) {
	return _Abi.Contract.Withdraw(&_Abi.TransactOpts, wad)
}
...
func (_Abi *AbiFilterer) FilterApproval(opts *bind.FilterOpts, src []common.Address, guy []common.Address) (*AbiApprovalIterator, error) {
	...
	logs, sub, err := _Abi.contract.FilterLogs(opts, "Approval", srcRule, guyRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Approval(address indexed src, address indexed guy, uint256 wad)
func (_Abi *AbiFilterer) WatchApproval(opts *bind.WatchOpts, sink chan<- *AbiApproval, src []common.Address, guy []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Abi.contract.WatchLogs(opts, "Approval", srcRule, guyRule)
	if err != nil {
		return nil, err
	}
...
func (_Abi *AbiFilterer) FilterDeposit(opts *bind.FilterOpts, dst []common.Address) (*AbiDepositIterator, error) {
	...
	logs, sub, err := _Abi.contract.FilterLogs(opts, "Deposit", dstRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Deposit(address indexed dst, uint256 wad)
func (_Abi *AbiFilterer) WatchDeposit(opts *bind.WatchOpts, sink chan<- *AbiDeposit, dst []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Abi.contract.WatchLogs(opts, "Deposit", dstRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
func (_Abi *AbiFilterer) FilterTransfer(opts *bind.FilterOpts, src []common.Address, dst []common.Address) (*AbiTransferIterator, error) {
	...
	logs, sub, err := _Abi.contract.FilterLogs(opts, "Transfer", srcRule, dstRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Transfer(address indexed src, address indexed dst, uint256 wad)
func (_Abi *AbiFilterer) WatchTransfer(opts *bind.WatchOpts, sink chan<- *AbiTransfer, src []common.Address, dst []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Abi.contract.WatchLogs(opts, "Transfer", srcRule, dstRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// AbiWithdrawalIterator is returned from FilterWithdrawal and is used to iterate over the raw logs and unpacked data for Withdrawal events raised by the Abi contract.
type AbiWithdrawalIterator struct {
	Event *AbiWithdrawal // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *AbiWithdrawalIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *AbiWithdrawalIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *AbiWithdrawalIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// AbiWithdrawal represents a Withdrawal event raised by the Abi contract.
type AbiWithdrawal struct {
	Src common.Address
	Wad *big.Int
	Raw types.Log // Blockchain specific contextual infos
}
...
func (_Abi *AbiFilterer) FilterWithdrawal(opts *bind.FilterOpts, src []common.Address) (*AbiWithdrawalIterator, error) {
	...
	logs, sub, err := _Abi.contract.FilterLogs(opts, "Withdrawal", srcRule)
	if err != nil {
		return nil, err
	}
	return &AbiWithdrawalIterator{contract: _Abi.contract, event: "Withdrawal", logs: logs, sub: sub}, nil
}

// WatchWithdrawal is a free log subscription operation binding the contract event 0x7fcf532c15f0a6db0bd6d0e038bea71d30d808c7d98cb3bf7268a95bf5081b65.
//
// Solidity: event Withdrawal(address indexed src, uint256 wad)
func (_Abi *AbiFilterer) WatchWithdrawal(opts *bind.WatchOpts, sink chan<- *AbiWithdrawal, src []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Abi.contract.WatchLogs(opts, "Withdrawal", srcRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				if err := _Abi.contract.UnpackLog(event, "Withdrawal", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Withdrawal(address indexed src, uint256 wad)
func (_Abi *AbiFilterer) ParseWithdrawal(log types.Log) (*AbiWithdrawal, error) {
	event := new(AbiWithdrawal)
	if err := _Abi.contract.UnpackLog(event, "Withdrawal", log); err != nil {
		return nil, err
	}
