...
// // 	Use:   "wallet",
// // 	Short: "Manage account and wallets for goml",
...
// var walletCmd = &cobra.Command{
// 	Use:   "wallet",
// 	Short: "Manage payment wallet private key (validator nodes only)",
// 	Long: `Validator node are required to perform onchain transactions when redeeming rewards.
// 	The payer wallet should be funded to allow for payment of gas feeß:
...
// 	Use:   "init",
// 	Short: "Initialize new private key in keystore",
// 	Long: `Initialized private key or mnemonic in keystore:
...
// 			return
// 		}
// 		pKey = ecdsa.PrivateKey(d)
// 	}
//     // Derive the private key using a specific derivation path (BIP-44 standard)
//     path := accounts.DefaultBaseDerivationPath // Ethereum's standard derivation path: m/44'/60'/0'/0/0

//     // Create an HD wallet and derive the key
//     privateKey, err := derivePrivateKeyFromSeed(seed, path)
//     if err != nil {
