...
func (n GenericAPI) GetChainInfo() (ChainInfo, error) {
 ...
 return ChainInfo{CurrentBlock: curBlock, StartBlock: startBlock , CurrentCycle: cycle, CurrentEpoch: epoch, StartTime: big.NewInt(NetworkStartDate)}, nil
}
...
func (n GenericAPI) GetValidatorLicenceOperator(license *big.Int) ([]byte, error) {
	operator1, _ := hex.DecodeString("03d212263468365e70b2d673b06b903216b5e101d8243cdbfac6884369e3c069a0")
	operator2, _ := hex.DecodeString("02733cc67380d6a8f4dad591126e08bd4d8f4471de0cc611f8cbc05461a85fb5c3")
...
func (n *GenericAPI) LicenceOperator(license *big.Int) ([]byte, error) {
...
func (n GenericAPI) ClaimReward(claim entities.ClaimData) (hash string, err error) {
